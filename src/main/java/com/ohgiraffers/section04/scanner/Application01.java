...
//        Calculator calc = new Calculator();   // Alt+엔터를 누르면 Calculator를 사용하겠다

//        Scanner sc = new Scanner(System.in);  // Alt+엔터를 누르면 Scanner를 사용하겠다
...
//        java.util.Scanner sc = new java.util.Scanner(System.in);
        ...
        /* 목차. 1-2. 다른 패키지에 있는 클래스 사용 시 패키지명을 생략하기 위해 import를 사용*/
       ...
       /* 목차. 2. 자료형별 값 입력받기 */
        ...
        System.out.print("참과 거짓 둘 중 한 가지를 true or false로 입력해주세요 : ");
